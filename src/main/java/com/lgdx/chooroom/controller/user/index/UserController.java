...
public class UserController {
    ...
    @PostMapping("/login")
    public ResponseEntity<String> login(@RequestParam("customerId")  String customerId, @RequestParam("customerPw")  String customerPw) {
    ...
    @GetMapping("/check-id")
    public ResponseEntity<Boolean> checkUserId(@RequestParam("customerId") String customerId) {
